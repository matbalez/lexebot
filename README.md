...
```bash
curl -L -o lexebot-v0.1.9-aarch64-apple-darwin.tar.gz \
  https://github.com/matbalez/lexebot/releases/download/v0.1.9/lexebot-v0.1.9-aarch64-apple-darwin.tar.gz
curl -L -o lexebot-v0.1.9-aarch64-apple-darwin.tar.gz.sha256 \
  https://github.com/matbalez/lexebot/releases/download/v0.1.9/lexebot-v0.1.9-aarch64-apple-darwin.tar.gz.sha256
shasum -a 256 -c lexebot-v0.1.9-aarch64-apple-darwin.tar.gz.sha256
mkdir -p ~/.local/bin
tar -xzf lexebot-v0.1.9-aarch64-apple-darwin.tar.gz
